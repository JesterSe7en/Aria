...
OpenGLVertexArray::OpenGLVertexArray() : mRendererID(0), mVertexBufferIndex(0), mIndexBuffer(nullptr) {
    ...
    switch (element.mType) {
      ...
      case ShaderPrimitiveType::Float4:
        ...
        glVertexAttribPointer(mVertexBufferIndex, element.get_element_count(),
                              ShaderPrimitiveToOpenGLPrimative(element.mType), element.mNormalized, layout.get_stride(),
      ...
      case ShaderPrimitiveType::Bool:
        ...
        glVertexAttribIPointer(mVertexBufferIndex, element.get_element_count(),
                               ShaderPrimitiveToOpenGLPrimative(element.mType), layout.get_stride(),
                               (const void*)element.mOffset);
        break;
